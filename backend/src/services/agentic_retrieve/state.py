"""
state.py — Agentic retrieval pipeline state types.

These TypedDicts define the LangGraph state that flows through the
agentic graph nodes. For API-level shared types, see src.schemas.
"""
...
class AgentState(TypedDict, total=False):
    # Normalization is handled by middleware — query_bundle arrives pre-built
