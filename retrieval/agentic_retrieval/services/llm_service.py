...
class LLMService:
    ...
    retry_attempts: int = 2  # initial try + 1 retry
    ...
    def invoke(self, prompt: str) -> str:
        ...
        for attempt in range(1, self.retry_attempts + 1):
            try:
                ...
                # Defensive fallback if SDK returns an unexpected but non-exceptional shape
        ...
        # Preserve existing behavior expectation: caller can still parse JSON and continue.
        # If you want hard failures instead, replace this with `raise last_error`.
        return self._empty_result_json()
